...
const app = express()
    ...
    app.use((request,response, next) => {
      ...
      app.get('/cursos/:curse', cors(), async function(request,response,next){
          let chave = request.params.curse
          let cursos = getCurso(chave)
      ...
      //Endpoint listagem alunos sistemas
        ...
        app.get('/alunos/:curso', cors(), async function(request,response,next){
            ...
            let alunos = getAlunosbyCurso(chave)
